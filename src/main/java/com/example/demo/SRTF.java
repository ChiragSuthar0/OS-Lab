...
public class SRTF {
    public String Main(int numberOfProcess, ArrayList<Integer> BT, ArrayList<Integer> AT) throws IOException
    {
        int n;
...
//        System.out.println();
        ...
        for(int i = 1; i <= n; i++)
        {
            r = r + String.format("%d\t\t%2dms\t\t%2dms\n",i,proc[i][2],proc[i][3]);
//            System.out.printf("%d\t%2dms\t%2dms",i,proc[i][2],proc[i][3]);
//            System.out.println();
        }
        r = r + String.format("The Average WT is: " + WT + "ms\n");
        r = r + String.format("The Average WT is: " + TT + "ms");
